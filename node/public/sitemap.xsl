  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/sites/all/modules/contrib/xmlsitemap/xsl/jquery.tablesorter.min.js"></script>
        <script type="text/javascript" src="/sites/all/modules/contrib/xmlsitemap/xsl/xmlsitemap.xsl.js"></script>
        <link href="/sites/all/modules/contrib/xmlsitemap/xsl/xmlsitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
